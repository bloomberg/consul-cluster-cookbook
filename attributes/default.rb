...
default['consul-cluster']['config']['manage_tls'] = false

default['consul-cluster']['tls']['common_name'] = 'consul.corporate.com'
...
default['consul-cluster']['tls']['ssl_chain']['path'] = '/etc/consul/ssl/CA/ca.crt'
